...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<void> _loadUser() async {
    try {
      ...
      // ✅ getMyProfile retourne UserProfile? (nullable)
  ...
  Future<void> _loadNotifications() async {
    try {
      ...
      if (mounted) {
        setState(() => _notificationCount = notifs.length);
      }
    } catch (_) {}
  }
  ...
  Future<void> _onMoodSelected(Mood mood) async {
    ...
    try {
      ...
      if (mounted) {
        setState(() => _recommended = reco);
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Erreur lors de l\'enregistrement de l\'humeur'),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Vous avez rejoint "${activity.title}" !',
  ...
  Widget _buildProfileSection() {
    ...
    if (_user == null) {
      return Container(
        ...
        child: const Center(
          child: Text('Profil non disponible'),
        ),
      );
    }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (activity.participantsLabel != null) ...[
                  const SizedBox(height: 4),
                  Row(
                    children: [
                      Icon(
            ...
            children: _categories.map((cat) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? const Color(0xFFD63FBF).withOpacity(0.1)
                        : Colors.white,
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                      color: isSelected
