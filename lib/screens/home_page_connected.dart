...
import 'package:wejoy/screens/activitie_page.dart'; // Ajout de l'import manquant
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  final Map<String, ImageProvider> _imageCache = {}; // Conservé de la version upstream
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text("Erreur lors de l'enregistrement de l'humeur"),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Stack(children: [
          ...
          if (_notificationCount > 0) Positioned(
            top: 8, right: 8,
            child: Container(
              width: 18, height: 18,
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Icon(_navItems[i]['icon'] as IconData, size: 22,
  ...
  Widget _buildWelcomeCard() {
    final name = _loadingUser ? '...' : (_user?.username ?? '');
    return Container(
      ...
      child: Row(children: [
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const Text('Connectez-vous, partagez et épanouissez-vous avec votre communauté.',
      ...
      child: Column(children: [
        ...
        Row(children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: const Color(0xFFD63FBF).withOpacity(0.3), blurRadius: 12, offset: const Offset(0, 4))],
            ),
            child: Center(
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 4),
            Text("Centres d'intérêt", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.grey[700])),
          ],
        ),
        const SizedBox(height: 8),
        _user!.interests.isEmpty
            ? Text('Aucun centre d\'intérêt défini', style: TextStyle(fontSize: 12, color: Colors.grey[400]))
            : Wrap(
                spacing: 8, runSpacing: 8,
                children: _user!.interests.map((interest) {
                  const icons = {'Cuisine': '🍳', 'Lecture': '📚', 'Jardinage': '🌱', 'Yoga': '🧘', 'Sport': '⚽', 'Autre': '✨'};
                  return Container(
          ...
          child: Row(children: [
            Expanded(
              child: Column(children: [
                ...
                const SizedBox(height: 4),
                Text('${_user!.points}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFFEAB308))),
            ...
            Expanded(
              child: Column(children: [
                const Text('⭐', style: TextStyle(fontSize: 24)),
                const SizedBox(height: 4),
                Text('${_user!.badges}', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFFD63FBF))),
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: const Color(0xFFD63FBF).withOpacity(0.1), borderRadius: BorderRadius.circular(4)),
                  child: Text(activity.category, style: const TextStyle(fontSize: 9, color: Color(0xFFD63FBF), fontWeight: FontWeight.w600)),
                ),
                const SizedBox(height: 6),
            ...
            child: Container(
              ...
              child: activity.imageUrl.isNotEmpty
                  ? Image.network(
                      ...
                      loadingBuilder: (context, child, loadingProgress) {
                        if (loadingProgress == null) return child;
                        return const Center(child: CircularProgressIndicator(color: Color(0xFFD63FBF), strokeWidth: 2));
                      },
                      errorBuilder: (_, __, ___) => const Icon(Icons.image_rounded, color: Color(0xFFD63FBF)),
                    )
