...
class _ProfilePageState extends State<ProfilePage> with TickerProviderStateMixin {
  ...
  final List<String> _allInterests = ['Cuisine', 'Lecture', 'Jardinage', 'Yoga', 'Sport', 'Autre'];
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _user = user;
          // Filtrer les activités rejointes
          _myActivities = activities.where((a) => a.currentParticipants! > 0).toList();
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Stack(children: [
            Container(
              ...
              child: ClipOval(child: _user?.avatarUrl != null && _user!.avatarUrl!.isNotEmpty
                ? CachedNetworkImage(
  ...
  Widget _activityRow(Activity a) {
    const catColors = {
      ...
      'Yoga': Color(0xFF96CEB4), 'Sport': _violet, 'Jardinage': Color(0xFF45B7D1), 'Autre': _slate,
    };
  ...
  Widget _buildSettings() {
    return _sectionCard(
      ...
      iconColor: _slate,
      child: Column(children: [
        _settingRow(Icons.edit_outlined, 'Modifier le profil', _rose, () => setState(() => _editing = !_editing)),
        _divider(),
        _settingRow(Icons.lock_outline_rounded, 'Changer le mot de passe', _violet, () {}),
        _divider(),
        _settingRow(Icons.notifications_outlined, 'Notifications', _slate, () {}),
        _divider(),
        _settingRow(Icons.logout_rounded, 'Se déconnecter', const Color(0xFFEF4444), () async {
          await _api.logout();
