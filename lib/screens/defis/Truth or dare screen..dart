...
class TruthOrDareScreen extends StatefulWidget {
  ...
  final bool isHost;
  final List<dynamic> initialPlayers; // ✅ FIX
...
class _TruthOrDareScreenState extends State<TruthOrDareScreen>
  ...
  static const _bg     = Color.fromARGB(255, 255, 247, 251);
  static const _card   = Color.fromARGB(255, 250, 118, 180);
  static const _amber  = Color.fromARGB(255, 93, 3, 105);
  static const _purple = Color(0xFF8B5CF6);
  static const _red    = Color(0xFFEF4444);

  // ── Lobby ──
  late List<dynamic> _players; // ✅ FIX : late + initialisé depuis widget
  ...
  void initState() {
    ...
    // ✅ FIX : partir avec les players déjà capturés dans GamesHub
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const SweepGradient(
                  colors: [_amber, _purple, _red, _amber]),
              boxShadow: [
                BoxShadow(
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Container(
        ...
        child: Text(
          isMe
              ? '⚡ C\'est ton tour !'
              : '🎯 C\'est le tour de $_currentPlayer',
          style: TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w700,
              color: isMe ? _amber : Colors.white54),
        ),
      ),
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.timer_outlined,
              size: 16,
              color: _countdown <= 10 ? _red : Colors.white38),
